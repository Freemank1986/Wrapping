  ...
  return (
    <>
      <section className="relative overflow-hidden">
        <div
          className="pointer-events-none absolute -top-24 right-0 h-96 w-96 rounded-full bg-secondary/70 blur-3xl"
          aria-hidden
        />
        <div
          className="pointer-events-none absolute -bottom-32 left-0 h-80 w-80 rounded-full bg-accent/10 blur-3xl"
          aria-hidden
        />
      ...
      <section className="mx-auto max-w-6xl px-4 py-24 sm:px-6">
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-3">
          {painPoints.map((point) => (
            <div
              key={point.title}
              className="group rounded-3xl border border-border bg-card p-7 transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl"
            >
      ...
      <section className="mx-auto max-w-6xl px-4 py-24 sm:px-6">
        ...
        <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {TIERS.map((tier) => (
            <div
              key={tier.value}
              className={`group rounded-3xl border p-6 transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl ${
